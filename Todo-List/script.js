...
editInput.setAttribute('class', 'todo-edit-input');
...
function getTodoHtml(todo, index) {
  ...
  return /* html */ `
    <li class="todo">
      ...
      <button class="edit-btn" onclick="edit(${index})"><i class="fa fa-pencil-alt"></i></button>
...
function edit(todoIndex) {
  ...
  const todoName = todoText.innerText;
  ...
  editInput.addEventListener('click', (e) => {
    if (e.key === 'Enter') {
      ...
      if (newTodoName) {
        todosJson[todoIndex].name = newTodoName;
        localStorage.setItem('todos', JSON.stringify(todosJson));
        showTodos();
      }
    }
